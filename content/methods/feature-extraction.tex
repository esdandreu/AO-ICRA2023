...
% TODO Review33: On page 3, equation 1, the authors do not discuss the sound
% propagation model. Do the author assume that the sound propagation is
% far-field or near-field. Does this effect the performance of the CNN
% classifiers?
