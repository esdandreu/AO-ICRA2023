...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
    \end{tabular}
    % TODO Review39: There is inconsistency in the criterion used to measure
    % prediction quality. in table 2, RPE is represented with unit(m/s) while
    % in Figure 5-8, they are using (m).
...
% TODO Remove Visual SLAM claims
