...
\Cref{fig:high-slip} shows that the overall predicted curve is very similar
...
% Similarly, using wheel odometry to estimate the wheel angular speed while
% using the proposed system to identify the wheel slippage may improve the
